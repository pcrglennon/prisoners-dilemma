...
public class RuleFactory {
	...
	private static String[] sM1 = {"Cooperate", "Defect", "Opp. Prev.", "! Opp. Prev.", "Your Prev.", "! Your Prev.", "Anything"};
	...
	public static void getRule0Vals(String rule){
		...
		overUnder4 = (ruleString[4]=="At least"?0:1); //0 - over or equal to, under (not equal to)
